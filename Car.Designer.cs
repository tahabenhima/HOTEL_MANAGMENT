namespace HOTEL_MANAGMENT
{
    partial class Car
    {
        ...
        private void InitializeComponent()
        {
            ...
            consulterCarButton = new Guna.UI2.WinForms.Guna2Button();
            ...
            label4.Location = new Point(423, 130);
            label4.Name = "label4";
            ...
            label1.Location = new Point(423, 61);
            label1.Name = "label1";
            ...
            // NomCarBox
            // 
            NomCarBox.Location = new Point(234, 52);
            ...
            // MatriculeCarBox
            // 
            MatriculeCarBox.Location = new Point(234, 130);
            ...
            // MarqueCarBox
            // 
            MarqueCarBox.Location = new Point(511, 53);
            ...
            // ColorCarBox
            // 
            ColorCarBox.Location = new Point(511, 127);
            ...
            AddCar.Location = new Point(53, 358);
            ...
            // consulterCarButton
            // 
            consulterCarButton.CustomizableEdges = customizableEdges3;
            consulterCarButton.DisabledState.BorderColor = Color.DarkGray;
            consulterCarButton.DisabledState.CustomBorderColor = Color.DarkGray;
            consulterCarButton.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            consulterCarButton.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            consulterCarButton.Font = new Font("Segoe UI", 9F);
            consulterCarButton.ForeColor = Color.White;
            consulterCarButton.Location = new Point(216, 358);
            consulterCarButton.Margin = new Padding(2);
            consulterCarButton.Name = "consulterCarButton";
            consulterCarButton.ShadowDecoration.CustomizableEdges = customizableEdges4;
            consulterCarButton.Size = new Size(128, 33);
            consulterCarButton.TabIndex = 26;
            consulterCarButton.Text = "Cosulter Car";
            consulterCarButton.Click += consulterCarButton_Click;
            // 
            // UpdateCar
            // 
            UpdateCar.CustomizableEdges = customizableEdges5;
            ...
            UpdateCar.Location = new Point(216, 359);
            UpdateCar.Margin = new Padding(2);
            UpdateCar.Name = "UpdateCar";
            UpdateCar.ShadowDecoration.CustomizableEdges = customizableEdges6;
            ...
            // DeleteCar
            // 
            DeleteCar.CustomizableEdges = customizableEdges7;
            ...
            DeleteCar.Location = new Point(423, 358);
            DeleteCar.Margin = new Padding(2);
            DeleteCar.Name = "DeleteCar";
            DeleteCar.ShadowDecoration.CustomizableEdges = customizableEdges8;
            ...
            // ReadCar
            // 
            ReadCar.CustomizableEdges = customizableEdges9;
            ...
            ReadCar.Location = new Point(608, 358);
            ReadCar.Margin = new Padding(2);
            ReadCar.Name = "ReadCar";
            ReadCar.ShadowDecoration.CustomizableEdges = customizableEdges10;
            ...
            getCarId.Location = new Point(63, 127);
            getCarId.Name = "getCarId";
            getCarId.Size = new Size(52, 15);
            ...
            Controls.Add(consulterCarButton);
            Controls.Add(AddCar);
        ...
        private Guna.UI2.WinForms.Guna2Button consulterCarButton;
